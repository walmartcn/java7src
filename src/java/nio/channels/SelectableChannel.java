 ...
 * A key may be cancelled explicitly 明确地 by invoking its {@link
 ...
 * further delay.
 *
 * <p> A channel may be registered at most once with 最多一次 any particular selector.
 *
 ...
 * 一个selectable chanel要么在blocking 模式，要么在非blocking模式
 ...
 * 新创建的selectable channels都在blocking mode。
 * 非blocking mode多同基于selector的多路复用一起。
 *
